	...
	<div class="col-3">
		<div class="card mb-4">
			...
			<div class="card-body px-4 pt-4 pb-4" style="height:600px; overflow:auto">
				<?php echo form_open_multipart('lokasi/edit/'.$lokasi->id) ?>

				<div class="form-group">
					<label class="form-control-label" for="desa">Desa</label>
					<input type="text" class="form-control" id="desa" name="desa" required value="<?=$lokasi->desa?>">
				</div>
				<div class="form-group">
					<label class="form-control-label" for="kepala_desa">Kepala Desa</label>
					<input type="text" class="form-control" id="kepala_desa" name="kepala_desa" required value="<?=$lokasi->kepala_desa?>">
				</div>
				<div class="form-group">
					
					<label class="form-control-label" for="dana_desa">Dana Desa</label>
					<input type="text" class="form-control" id="dana_desa" name="dana_desa" required value="<?=$lokasi->dana_desa?>">
				</div>
				<div class="form-group">
					<label class="form-control-label" for="alokasi_dana_desa">Alokasi Dana Desa</label>
					<input type="text" class="form-control" id="alokasi_dana_desa" name="alokasi_dana_desa" required value="<?=$lokasi->alokasi_dana_desa?>">
				</div>
				<div class="form-group">
					<label class="form-control-label" for="kecamatan">Kecamatan</label>
					<input type="text" class="form-control" id="kecamatan" name="kecamatan" required value="<?=$lokasi->kecamatan?>">
				</div>
				<div class="form-group">
					<label class="form-control-label" for="kabupaten">Kabupaten</label>
					<input type="text" class="form-control" id="kabupaten" name="kabupaten" required value="<?=$lokasi->kabupaten?>">
				</div>
				<div class="form-group">
					<label class="form-control-label" for="provinsi">Provinsi</label>
					<input type="text" class="form-control" id="provinsi" name="provinsi" required value="<?=$lokasi->provinsi?>"
				</div>

				<div class="form-group">
					<label class="form-control-label" for="latitude">Latitude</label>
					<input readonly type="text" class="form-control" id="Latitude" name="latitude" required value="<?=$lokasi->latitude?>">
				</div>
				<div class="form-group">
					<label class="form-control-label" for="longitude">Longitude</label>
					<input readonly type="text" class="form-control" id="Longitude" name="longitude" required value="<?=$lokasi->longitude?>">
				</div>
